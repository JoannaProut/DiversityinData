...
If I make a chart that looks okay for the blog then I have to change the font sizing around to make an image file where all the words aren't teeny-tiny.  I am not sure if there is a better way around this.

```{r have to change around to make an image that saves well??}
